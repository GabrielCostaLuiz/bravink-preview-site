        ...
        <Reveal width="100%" overflowHidden={false}>
          <div className="bg-primary dark:bg-slate-950 rounded-3xl shadow-2xl relative group hover:shadow-accent/20 transition-all duration-500 border border-transparent dark:border-slate-800">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center relative z-10 p-8 md:p-12 lg:p-16">
              ...
              <div className="max-w-xl">
                ...
                <Reveal delay={400} direction="left">
                  <p className="text-white/70 text-lg mb-8 leading-relaxed">
                    Não deixe para depois. Nossa equipe de especialistas está
                    pronta para analisar seu perfil e desenhar o melhor cenário
              ...
              <div className="hidden lg:block relative h-full min-h-[450px]">
                <Reveal
                  delay={400}
                  direction="right"
                  className="h-full"
                ...
                >
                  <div className="relative h-full w-full flex items-end justify-end">
                    <div className="absolute bottom-0 right-0 translate-y-8 translate-x-4">
                      {/* Using a professional consultant image with a gradient mask at the bottom */}
                      <img
                        src={IMAGES.CONSULTANT}
                        alt="Especialista Bravink"
                        className="h-[500px] w-auto object-contain transition-transform rounded-lg duration-700 group-hover:scale-105"
                        style={{
                          maskImage:
